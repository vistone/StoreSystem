...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    for &size in &[1024, 1024 * 1024, 10 * 1024 * 1024] {
        ...
        println!("  平均: {:.2}ms  P50: {:.2}ms  最小: {:.2}ms  最大: {:.2}ms",
                 avg.as_secs_f64() * 1000.0,
                 p50.as_secs_f64() * 1000.0,
                 min.as_secs_f64() * 1000.0,
                 max.as_secs_f64() * 1000.0);
        println!("  吞吐: {:.0} ops/s, {:.1} MB/s",
    ...
    println!("  10 条并发总耗时: {:.2}ms", conc_total.as_secs_f64() * 1000.0);
    println!("  平均每条: {:.2}ms", conc_total.as_secs_f64() * 1000.0 / 10.0);
